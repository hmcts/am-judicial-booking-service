...
import uk.gov.hmcts.reform.judicialbooking.launchdarkly.FeatureConditionEvaluation;
...
public class LaunchDarklyConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(featureConditionEvaluation).addPathPatterns("/am/bookings");
        registry.addInterceptor(featureConditionEvaluation).addPathPatterns("/am/bookings/query");
    }
}
