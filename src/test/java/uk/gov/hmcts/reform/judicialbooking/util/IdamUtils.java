...
public class IdamUtils {
    ...
    public String getIdamOauth2Token(String username, String password) {
        ...
        AuthApi.TokenExchangeResponse tokenExchangeResponse = idamApi.exchangeCode(
            authenticateUserResponse.getCode(),
            AUTHORIZATION_CODE, oauth2.getClientId(),
            oauth2.getClientSecret(), oauth2.getRedirectUri());
